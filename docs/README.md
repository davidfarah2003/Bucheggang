...
| [idea/](idea/) | Product design: [viseca-agent-control-layer.md](idea/viseca-agent-control-layer.md) |
| [papers/](papers/) | The four research papers (PDF) |
| [research/](research/) | Research notes and findings, by date |
| eval/ | Labels, replay outputs and the report (created by plan 06) |
| screens/, pitch/ | Demo assets (created by plans 04 and 06) |

The organizer material stays in [../viseca-2026/](../viseca-2026/).
