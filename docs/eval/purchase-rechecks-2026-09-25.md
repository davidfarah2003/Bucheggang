...
The fresh mandate read on repeated `buy` and an authenticated HTTP answer still require live lifecycle verification. A later [recording-recovery change](local-purchase-recovery-2026-09-25.md) exercised real process exits during isolated local approval, step-up and timeout writes. Recovery through the complete authenticated lifecycle remains unverified. These observations do not establish a complete customer Wallet journey. No test suite or linter was run.
