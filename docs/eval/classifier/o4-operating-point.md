...
Activation still requires the approved provider rounding contract to land in the shared and adapter validators, complete real-provider coverage, assessment-output binding, independent review of the exact integrated head, current policy/state and deadline checks, and a genuine Wallet customer-answer run. The runner still rejects a fired escalation. No provider, simulator or Wallet call was made for this selection.
