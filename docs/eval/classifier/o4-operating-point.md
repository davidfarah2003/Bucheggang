...
Activation still requires an owner-approved provider rounding contract, complete real-provider coverage, authenticated assessment-output binding, independent review of the exact integrated head, current policy/state and deadline checks, and a genuine Wallet customer-answer run. The evaluation-only manifest and runner gate remain unchanged. No provider, simulator or Wallet call was made for this selection.
