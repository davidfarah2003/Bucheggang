...
| --- | --- | --- | --- |
| M0 re-anchor, scope, contract proposal, ownership map | r1 complete: gemini and grok APPROVE, glm BLOCK G1; corrections made, r2 target pending freeze | [02-classifier-m0.md](02-classifier-m0.md); r1 target `d651ef8`, [findings](../reviews/classifier/M0/r1/findings.md) | r2 pending |
