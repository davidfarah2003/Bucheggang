...
| M2 offline behavioural-model comparison | independent split preparation only; fitting not started | [split manifest](../eval/classifier/split-manifest.json) | not frozen |
