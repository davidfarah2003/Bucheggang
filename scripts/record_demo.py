...
async def main() -> None:
    ...
    try:
        async with async_playwright() as pw:
            ...
            await s.caption("The agent asks to connect. Alex taps once.", 0.1)
            ...
            await s.caption("The plan waits in the Wallet. Only Alex can authorize it.", 0.1)
            ...
            await s.caption("Plain-English rules, in Alex's words.", 0.2, side=True)
            ...
            await s.caption("Permission active. The agent shops.", 0.1)
            ...
            await s.caption("Rules, cart facts, card history, risk models.", 0.3, side=True)
